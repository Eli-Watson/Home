const holidays = [
    ...
    { name: "Washington's Birthday", date: "February 21", message: "The day a 6 foot dude that lead our armies to vicotry aginst the tea trinkers was born" },
    ...
    { name: "April Fool's Day", date: "April 1", message: "Prank somebody!" },
    { name: "US Army Day", date: "April 6", message: "Where Does a General Keep his armys? in his Sleevies!!" },
    { name: "Arbor Day", date: "April 26", message: "Hug a tree." },
    { name: "Mother's Day", date: "May 12", message: "Give Your mom a call." },
    ...
    { name: "Father's Day", date: "June 15", message: "Dads are some of the most important people in a child's life. Treat them as such.S" },
    ...
    { name: "Independence Day", date: "July 4", message: "Blow up the sky and tease Britain. Click here for fireworks: <a href=/Demos/Fireworks>here</a>" },
    ...
    { name: "US Navy Day", date: "October 27", message: "They Got boats. Big boats. Lots of Big Boats. Big Boats With Big Guns." },
